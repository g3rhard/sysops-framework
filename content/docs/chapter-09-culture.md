...
| **Engineering Manager** (also: Team Lead, Team Leader, Delivery Lead, Process Owner)       | People management, prioritisation, stakeholder communication, removing blockers                                                   | Weekly Improvement — runs the retro and priority review | Team & Skill Development (6), Knowledge & Documentation (5), Vendor & Contract (7) | "Who is on-call next week?" "What improvement do we fund this quarter?" "Can the team absorb this new service?"        |
...
| **On-Call Engineer** (also: Duty Engineer, Incident Responder)                             | Rotating responsibility for incident response during assigned shifts (where 24/7 rotation applies)                                | Daily Operations — shift execution                      | Incident & Problem (2), Knowledge & Documentation (5)                              | "Is this a P1 or P2?" "Do we need to wake up the Service Owner?" "Is the runbook correct?"                             |
| **Incident Commander** (also: Incident Manager, Bridge Lead)                               | Coordination during major incidents — does NOT debug, keeps the response organised                                                | Daily Operations — activated per incident               | Incident & Problem (2)                                                             | "Who is on the bridge?" "Do we escalate to the director?" "What do we tell customers?"                                 |
| **SRE** (also: Reliability Engineer, Ops Engineer, Operations Engineer, Platform Engineer) | Automation, monitoring, reducing toil, improving system reliability across the platform                                           | Weekly Improvement — implements automation projects     | Release Management (8), Service Request (10), Change & Configuration (3)           | "Which manual step do I automate next?" "Is this change safe to standardise?"                                          |
